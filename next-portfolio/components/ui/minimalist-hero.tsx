            ...
            <div className="relative grid w-full max-w-7xl flex-grow grid-cols-1 items-center md:grid-cols-3">
                ...
                <div className="relative order-1 md:order-2 flex justify-center items-center h-full">
                    <motion.div
                        ...
                        className="absolute z-0 h-[300px] w-[300px] rounded-full bg-gradient-to-br from-primary to-secondary md:h-[400px] md:w-[400px] lg:h-[500px] lg:w-[500px]"
                    ></motion.div>
                    <motion.img
                        src={imageSrc}
                        alt={imageAlt}
                        className="relative z-10 h-auto w-56 object-cover md:w-64 scale-125 lg:w-72 rounded-full"
                        ...
                        onError={(e) => {
                            ...
                            target.onerror = null;
                            target.src = `https://placehold.co/400x600/8b5cf6/ffffff?text=SM`;
                        }}
                    />
                </div>
